                ...
                <dl className="sm:divide-y sm:divide-gray-200">
                  <div className="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                    ...
                    <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                      ...
                      allow us to remember your preferences and improve your
                      browsing experience.
                    </dd>
                  </div>
                  <div className="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                    ...
                    <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                      ...
                      device for a set period or until you delete them). We use
                      the following types of cookies:
                      <ul className="list-disc pl-5 mt-2">
                        <li>
                          Essential cookies: These are necessary for the website
                          to function properly.
                        </li>
                        <li>
                          Analytical/performance cookies: These help us improve
                        ...
                        <li>
                          Targeting cookies: These are used to deliver
                          advertisements more relevant to you and your
                          interests.
                        </li>
                      </ul>
                    </dd>
                  ...
                  <div className="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                    ...
                    <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                      ...
                      <ul className="list-disc pl-5 mt-2">
                        <li>
                          Understand and save user preferences for future
                          visits.
                        </li>
                        <li>
                          Compile aggregate data about site traffic and site
                          interactions to improve our website.
                        </li>
                        <li>
                  ...
                  <div className="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                    ...
                    <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                      ...
                      <ul className="list-disc pl-5 mt-2">
                        <li>
                          This site uses Google Analytics to help us understand
                          how our customers use the site. These cookies may
                          track things such as how long you spend on the site
                          and the pages that you visit.
                        </li>
                        <li>
                          We also use social media buttons and/or plugins on
                          this site that allow you to connect with your social
                          network in various ways. These will set cookies
                          through our site which may be used to enhance your
                          profile on their site or contribute to the data they
                          hold for various purposes.
                        </li>
                      </ul>
                    </dd>
                  </div>
                  <div className="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                    ...
                    <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                      ...
                      personalized to you. It may also stop you from saving
