...
export default function Component() {
  ...
  const faqs = [
    ...
    // {
    //   question: "What does the Majestic Cover protect?",
    //   answer:
    //     "Majestic Cover provides protection for both guests and properties. It includes compensation for verified damages, 24/7 safety support, and booking protection in case of last-minute cancellations or significant listing inaccuracies.",
    ...
    }, //our platform  3) For emergencies, use the SOS button in the app to reach our emergency team.
    {
      ...
      answer:
        "You can leave a review within 14 days after check-out. Once the deadline arrives, the review link will be permanently disabled. We use star based rating system where you can rate your stay and also describe your overall experience during the course of stay. ",
      categories: ["reviews"], //"You can leave a review within 14 days after check-out. Ratings cover cleanliness, communication, check-in, accuracy, location, and value. Reviews are published only after both guest and host have submitted their reviews or after the 14-day period ends.",
    },
  ];
